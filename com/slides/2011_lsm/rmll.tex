...
\definecolor{rRed}{rgb}{0.6,0.2,0.2}
\definecolor{rGreen}{rgb}{0.67,1,0.3}
...
\definecolor{lstkeyword}{rgb}{0.35, 0.65, 0.88}
\definecolor{lststring}{rgb}{0.67, 7, 0.33}
...
\draw [ultra thick, rounded corners=2pt, color=SkyBlue] (2.43,-0.81) rectangle (6.65,-0.54);
\draw [ultra thick, color=SkyBlue, ->, >=stealth] (5,-0.81) -- (3.3,-2.42);
\end{tikzpicture}
\end{frame}
...
\draw [ultra thick, rounded corners=2pt, color=LimeGreen] (2.43,0.44) rectangle (6.85,0.71);
\draw [ultra thick, color=LimeGreen, ->, >=stealth] (6.80,0.71) -- (2.9,2.55);
\draw [ultra thick, color=LimeGreen, ->, >=stealth] (6.80,0.44) -- (6.15,-2.70);
\end{tikzpicture}
\end{frame}
...
\draw [ultra thick, rounded corners=2pt, color=MediumOrchid] (2.8,-0.04) rectangle (5.85,-0.31);
\draw [ultra thick, color=MediumOrchid, ->, >=stealth] (5.7,-0.04) -- (5,2.27);
\draw [ultra thick, color=MediumOrchid, ->, >=stealth] (5.7,-0.31) -- (5,-3.22);
\end{tikzpicture}
\end{frame}
...
\begin{frame}{Prochaines étapes}
	...
	\begin{itemize}
		\item	Fosdem 2012;
		\item	Fin EIP;
		\item	Évolution vers python -> contributeur.
	\end{itemize}
	\end{center}
\end{frame}
