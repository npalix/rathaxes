...
More importantly, Rathaxes is now an open project: the language and the compiler are licensed under the GPLv3 while the code templates, which are specific to an operating systems or peripheral are licensed under a 3 clauses BSD license.
