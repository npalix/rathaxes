...
\begin{center}
\begin{tikzpicture}[overlay]
\node (Ubuntu) at (-3.60, 1.5) {\includegraphics[scale=0.08]{medias/buildbot_windows}};
\node (Windows) at (-3.10, 0.25) {\includegraphics[scale=0.08]{medias/buildbot_ubuntu}};
\node (Gcode) at (-4.10, -2.50) {\includegraphics[scale=0.08]{medias/gcode}};
