...
\rtxdoctype{COPIL} \rtxdocstatus{Brouillon} \rtxdocversion{0.4}

\rtxdochistory { 0.1 & 15/05/2011 & Louis Opter & Création du document à partir
  du template .docx \\ \hline 0.2 & 15/05/2011 & Louis Opter & Rédaction des
  chapitres sur la documentation et la méthodologie \\ \hline 0.3 & 16/05/2011 &
  Thomas Sanchez & Rédaction du chapitre sur la réalisation technique \\ \hline
...
Notre discours de communication à été pensé pour 2 public. Un public avertie et connaisseur et un public plus générale. 

Pour la conférence que nous organiserons lors Rencontre Mondiale du Logiciel Libre, nous parlerons plus du projet en terme de resultat qu'en terme technique car le public est moins ''spécialisé''. A l'inverse pour les conférences que nous produirons pour le laboratoire LSE et pour les T-Dose, nous axerons sur les aspects technique du projet car le publique est déjà spécialisé.
Il en sera de même pour les supports visuels.


%Pour construire notre discoure l'équipe à préférer organiser des conférence
%interne à EPITECH.
...
La seconde conférence aura lieu dans le cadre des Rencontres Mondiales du
Logiciel Libre. Cette conférence aura lieux à Strasbourg entre le 9 au 14
juillet. Nous avons demandé par aillieur un stande pour enrichire nos
rencontres.

Enfin, nous projetons de participer àd'autres rencontre internationale tel que
le T-Dose et le Fosdem.

Faire des conférences en interne puis en externe et avec de plus en plus
d'ampleur, permet de perfectionner nos présentation au fure et à mesure des
mois.
