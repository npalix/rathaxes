...
% Ce chapitre doit faire une page.
...
% Thomas S.: Il y a donc deux cibles...
...
%\begin{itemize}
% Thomas S. Pas d'accord, sur quoi se base-t-on pour dire ca ?
% un mec avec un bep electro technique pourrait se faire un truc
% avec RTX ou meme avec un IUT (bac + 2)
% \item Hautes Études d'ingénierie (Bac + 3 minimum) ;

% RTX est la pour eviter ca !!!!!!!!!!
...
% interne de quoi ? externe a quoi ?
Faire des conférences en interne puis en externe et avec de plus en plus de
monde permet de perfectionner nos présentations au fur et à mesure des mois. % "au fur et a mesure des mois" est un peu maladroit ... "au fur et a mesure" suffirait
...
\begin{itemize}
\item Une liste de diffusion publique ; % ou ?
\item Une liste de diffusion pour les développeurs ; % ou ?
\item Un wiki ; % ou ?
\item Un site vitrine. % ou ?
\end{itemize}
