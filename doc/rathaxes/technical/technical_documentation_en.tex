...
\section{Compilation and registration of a template}
\subsection{Common process between all templates}
\subsection{Specificities of the type templates}

\section{Compilation and registration of an interface}


\section{Compilation of a driver}
