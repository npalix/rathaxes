...
La génération n'est pas encore totalement implémentée. Cette section sera
complétée en temps voulu.
...
Quand une version plus stable de \rtx\ sera dans le dépôt nous compléterons les
