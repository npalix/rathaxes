...
La génération n'est pas encore totalement implementer. Cette section sera complétée en temps voulu.
TBD.
...
Quand une version plus stable de \rtx{} sera dans le dépôt nous completerons les
informations nécessaire pour comprendre ces 3 parties.
